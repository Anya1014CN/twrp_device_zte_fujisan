...
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 cma=32M@0-0xffffffff androidboot.selinux=permissive androidboot.usbconfigfs=true watchdog_v2.enable=0 subsystem_restart.disable_restart_work=0x9889deed fujisan.recovery_single_panel=1
